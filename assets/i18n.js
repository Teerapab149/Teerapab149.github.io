...
(() => {
  ...
  const TH = {
    ...
    '.hero__side .tag': 'สี่โปรเจกต์ · เส้นเรื่องเดียวกัน',
    ...
    '.hero__side p.small:nth-of-type(2)': 'สามโปรเจกต์แรกผมทำครบทั้งวงจร ตั้งแต่นั่งเก็บ requirement กับผู้ใช้ ' +
      'ออกแบบ ER diagram และ business flow ไปจนถึงเขียนโค้ด ทำ UI และ deploy เอง ' +
      'ส่วนโปรเจกต์ที่สี่ผมทำแค่ครึ่งแรกคือฝั่งออกแบบ แล้วส่งต่อให้คนเขียนโค้ด',
    ...
    /* ── project 01 ──────────────────────────────────────────────────────── */
    '.grow__over .tag': 'ระบบใช้งานจริง · โปรเจกต์ 01',
    ...
    /* ── project 04 ──────────────────────────────────────────────────────── */
    '#p04 .work__head .tag': 'โปรเจกต์ส่วนตัวกับเพื่อน · ยังทำอยู่',
    ...
    '#p04 .cols p.small': 'บอตสารพัดประโยชน์ที่เซิร์ฟเวอร์ Discord ของพวกเราใช้กันทุกวัน ' +
      ...
      'เป็นโปรเจกต์ที่ใกล้เคียงกับงานที่ผมสมัครมากที่สุด',
    ...
    /* ── buttons that repeat ─────────────────────────────────────────────── */
    '.btn[href="fms-election.html"]': 'อ่านเคสสตัดี้ฉบับเต็ม',
    '.btn[href="credit-tracker.html"]': 'อ่านเคสสตัดี้ฉบับเต็ม',
    '.btn[href="psu-chatbot.html"]': 'อ่านเคสสตัดี้ฉบับเต็ม',
    '.btn[href="megubot.html"]': 'อ่านเคสสตัดี้ฉบับเต็ม',
    ...
    '.role:nth-child(1) .small': 'ตรงกับสิ่งที่ผมทำมาจริงที่สุด — ทุกโปรเจกต์ในนี้ผมเริ่มจากเก็บ requirement ' +
    ...
    '#cv h2.big': 'สิ่งที่ได้ใช้จริงในโปรเจกต์ข้างบน',
    '.block:nth-child(1) h3': 'วิเคราะห์ระบบและธุรกิจ',
    '.block:nth-child(1) .tag': 'จุดเริ่มต้นของทุกโปรเจกต์',
    ...
    '.note .small': '<strong>เรื่องที่ผมพูดตรง ๆ เสมอ</strong> — ผมใช้ AI เป็นคู่คิดในการพัฒนาทุกโปรเจกต์ ' +
    ...
    '#contact p.small': 'ผมกำลังมองหา<strong>ฝึกงานสหกิจศึกษา ตั้งแต่ 16 พฤศจิกายน 2569 ถึง 7 มีนาคม 2570</strong> ' +
      ...
      '<strong>Management Trainee</strong> · ยินดีคุยรายละเอียดทุกโปรเจกต์แบบเจาะลึก เปิดโค้ดให้ดูได้',
