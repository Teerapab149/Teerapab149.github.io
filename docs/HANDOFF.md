...
6. **เวอร์ชันภาษาอังกฤษ** — ตอนนี้เป็นไทยล้วน ถ้าจะสมัครงานต่างชาติต้องทำ `en/index.html`
   หรือทำสวิตช์ภาษา (เนื้อหาภาษาอังกฤษบางส่วนมีใน `docs/CONTENT-SOURCE.md` ข้อ 12 แล้ว)
7. **เพิ่มโปรเจกต์อื่น** — โครงหน้าออกแบบมาให้เป็น case study เดี่ยว ถ้าจะเพิ่มโปรเจกต์ที่ 2
